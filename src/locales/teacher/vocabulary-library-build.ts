...
export const setBuildWizardT: Record<Language, SetBuildWizardStrings> = {
  en: {
    ...
    modePasteTitle: "Paste text",
    modePasteBlurb: "Paste a list — one word per line or comma-separated.",
    modePhotoTitle: "Photograph a page",
    modePhotoBlurb: "Snap a photo of a worksheet or page; AI extracts the words.",
  ...
  he: {
    ...
    modePasteTitle: "הדבקת טקסט",
    modePasteBlurb: "הדביקו רשימה — מילה בשורה או מופרדות בפסיק.",
    modePhotoTitle: "צילום עמוד",
    modePhotoBlurb: "צלמו דף עבודה או עמוד; ה־AI יחלץ את המילים.",
  ...
  ar: {
    ...
    modePasteTitle: "لصق نص",
    modePasteBlurb: "الصق قائمة — كلمة في كل سطر أو مفصولة بفواصل.",
    modePhotoTitle: "تصوير صفحة",
    modePhotoBlurb: "التقط صورة لورقة عمل أو صفحة، وسيستخرج الذكاء الاصطناعي الكلمات.",
