...
export const PREMIUM_AVATARS = [
  ...
  { id: 'wolf',           emoji: '🐺',    name: 'Wolf',          cost: 150 },
  { id: 'dinosaur',       emoji: '🦖',    name: 'Dinosaur',      cost: 175 },
  { id: 'wizard',         emoji: '🧙‍♂️',  name: 'Wizard',        cost: 225 },
  { id: 'superhero',      emoji: '🦸',    name: 'Superhero',     cost: 275 },
  { id: 'alien',          emoji: '👾',    name: 'Alien',         cost: 275 },
...
export type GameMode = "classic" | "listening" | "spelling" | "matching" | "memory-flip" | "true-false" | "flashcards" | "scramble" | "reverse" | "letter-sounds" | "sentence-builder" | "fill-blank" | "word-chains" | "idiom" | "speed-round" | "category-race" | "review" | "class-minute";
