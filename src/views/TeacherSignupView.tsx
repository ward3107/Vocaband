...
> = {
  en: {
    ...
    benefits: ['🎮 15 game modes', '💬 Hebrew & Arabic', '🏆 Live challenges'],
    nameLabel: 'Your name',
  ...
  he: {
    ...
    benefits: ['🎮 15 מצבי משחק', '💬 עברית וערבית', '🏆 אתגרים חיים'],
    nameLabel: 'השם שלכם',
  ...
  ru: {
    ...
    benefits: ['🎮 15 режимов игры', '💬 иврит и арабский', '🏆 живые состязания'],
    nameLabel: 'Ваше имя',
    namePlaceholder: 'например, Сара Коэн',
    schoolLabel: 'Ваша школа',
    schoolPlaceholder: 'Введите название школы или города…',
    noResults: 'Школа не найдена — вы всё равно можете продолжить.',
    notListed: 'Моей школы нет в списке',
    ...
    errStudent: 'Этот email зарегистрирован как ученик. Ученики входят по коду класса и PIN-коду.',
  ...
  ar: {
    ...
    benefits: ['🎮 15 نمط لعب', '💬 العبرية والعربية', '🏆 تحدّيات حيّة'],
    nameLabel: 'اسمك',
