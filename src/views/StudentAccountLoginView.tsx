...
interface StudentAccountLoginViewProps {
  ...
  existingStudents: Array<{ id: string; displayName: string; avatar?: string; xp: number }>;
  setExistingStudents: (v: Array<{ id: string; displayName: string; avatar?: string; xp: number }>) => void;
  ...
  AVATAR_CATEGORIES: Record<string, string[]>;
  // UI state
  error: string | null;
