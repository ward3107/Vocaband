...
const modeThemes: Record<GameMode, {
  ...
  "category-race":   { gradient: "from-pink-50 via-white to-fuchsia-50",         card: "from-pink-400 to-fuchsia-500",       stepBg: "bg-pink-50 border-pink-100",          stepNum: "bg-pink-500",         cta: "from-pink-500 to-fuchsia-500",        accent: "text-pink-700" },
  dreidel:           { gradient: "from-indigo-50 via-white to-fuchsia-50",        card: "from-indigo-500 to-fuchsia-600",     stepBg: "bg-indigo-50 border-indigo-100",      stepNum: "bg-indigo-500",       cta: "from-indigo-500 to-fuchsia-600",      accent: "text-indigo-700" },
