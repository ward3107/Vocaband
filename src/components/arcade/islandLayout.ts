...
const TOP = 120; // px below the fixed header before the first island
const GAP = 200; // vertical spacing between consecutive islands (clears the
                 // 112/128px glass medallions + their labels without overlap)
const BOTTOM_PAD = 176; // space below the last island (pet + label clearance)
