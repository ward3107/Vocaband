...
const STEPS_BY_LANG: Record<Language, Step[]> = {
  en: [
    ...
    { icon: '🎮', title: '10 Game Modes', description: 'Classic quiz, Spelling, Matching, Listening, Scramble, and more. Each mode helps you learn in a different way.' },
  ...
  he: [
    ...
    { icon: '🎮', title: '10 מצבי משחק', description: 'חידון קלאסי, איות, התאמה, האזנה, ערבול ועוד. כל מצב עוזר לכם ללמוד אחרת.' },
  ...
  ar: [
    ...
    { icon: '🎮', title: '10 أوضاع لعب', description: 'اختبار كلاسيكي، تهجئة، مطابقة، استماع، خلط، والمزيد. كل وضع يساعدك على التعلّم بطريقة مختلفة.' },
