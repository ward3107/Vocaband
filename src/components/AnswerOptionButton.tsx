...
const AnswerOptionButton = React.memo(({ option, currentWordId, feedback, gameMode, targetLanguage, onAnswer, themeColor, shortcutKey, showKeyHint }: {
  ...
  return (
    <button
      ...
      className={`relative py-5 px-5 sm:py-6 sm:px-8 lg:py-7 lg:px-10 rounded-xl sm:rounded-2xl text-xl sm:text-2xl lg:text-3xl font-bold motion-safe:transition-all duration-300 min-h-[88px] lg:min-h-[96px] flex items-center justify-center gap-2 ${
        showCorrect
