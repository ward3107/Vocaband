          ...
          <div className="max-w-7xl mx-auto w-full relative z-10">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center lg:text-left">
                ...
                >
                  <span className="inline-block pr-2 bg-gradient-to-r from-white via-white to-white/90 bg-clip-text text-transparent drop-shadow-2xl">
                    Level Up
                  </span>
                  <br />
                  <span className="inline-block pr-2 bg-gradient-to-r from-violet-400 via-fuchsia-400 to-amber-400 bg-clip-text text-transparent">
                    Your Vocabulary
                  </span>
                </motion.h1>
            ...
            <div className="relative p-12 md:p-20 rounded-[3rem] bg-gradient-to-br from-violet-600 via-purple-600 to-fuchsia-600 text-white text-center overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-4xl md:text-6xl lg:text-7xl font-black font-headline mb-6 tracking-tight">
                  Ready to Become a
                  <span className="inline-block pr-2 block mt-2 bg-gradient-to-r from-amber-300 via-yellow-200 to-amber-300 bg-clip-text text-transparent">
                    Vocabulary Legend?
                  </span>
                </h2>
