        ...
        <div className="px-6 py-5">
          ...
          {info.platform === 'android' && (
            <button
              ...
              className="mb-2 w-full rounded-2xl bg-gradient-to-r from-amber-500 via-orange-500 to-rose-500 px-4 py-3 text-base font-semibold text-white shadow-lg shadow-orange-500/30 transition active:scale-[0.98]"
            >
              {t.openInChrome}
            </button>
          )}
          ...
          <button
            ...
            onClick={copyUrl}
            style={{ touchAction: 'manipulation', WebkitTapHighlightColor: 'transparent' }}
            className={`mb-2 flex w-full items-center justify-center gap-2 rounded-2xl border-2 px-4 py-2.5 text-sm font-semibold transition active:scale-[0.98] ${
              copied
