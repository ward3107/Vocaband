      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full end-0 mt-2 py-1.5 rounded-lg bg-surface-container-lowest shadow-2xl border border-surface-container-highest overflow-hidden min-w-[170px] z-[100]"
          >
            {languages.map(lang => {
              ...
              return (
                ...
                >
                  ...
                  <span className="flex-1 text-start">{languageNames[lang]}</span>
