...
export const ShopSquare: React.FC<ShopSquareProps> = ({ xp, onOpen }) => {
  ...
  return (
    <button
      ...
      className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-600 via-violet-600 to-fuchsia-600 text-white shadow-xl ring-1 ring-white/10 p-4 sm:p-5 text-left hover:shadow-2xl hover:-translate-y-0.5 active:scale-[0.99] transition-all"
    >
      ...
      <div className="relative flex items-center gap-3 sm:gap-4">
        <div className="shrink-0 w-16 h-16 sm:w-20 sm:h-20 rounded-xl bg-white/20 backdrop-blur-sm flex items-center justify-center shadow-lg ring-2 ring-white/30">
