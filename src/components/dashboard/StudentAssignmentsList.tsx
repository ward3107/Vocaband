...
export default function StudentAssignmentsList({
  ...
  // v1 chrome — hairline indigo border + soft shadow, section-label
  // eyebrow (violet dot + uppercase) above the title, brand-violet accent
  // on the BookOpen glyph. Reads as a grouped-list panel on the iOS
  // grouped-light Tasks sheet.
  return (
    <div
