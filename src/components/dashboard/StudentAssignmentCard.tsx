...
// Uses the Student App v1 tamed-rainbow palette (violet · blue · mint ·
// amber · coral · pink) — same family as the redesigned vocabulary
// library set cards so a student's dashboard and library look like the
// same product.
const ACCENTS = [
  ...
  return (
    <div className="relative shrink-0" style={{ width: size, height: size }}>
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <span className="text-sm font-black tabular-nums text-stone-800">{Math.round(percent)}%</span>
      </div>
    </div>
  );
}
    ...
    >
      ...
      <div className="flex items-center gap-3 sm:gap-4">
        ...
        <div className="flex-1 min-w-0">
          <h3 className="text-base sm:text-lg leading-tight truncate font-black text-stone-900">
