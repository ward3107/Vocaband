...
import { BackBar, Panel, LevelBadge, FreqBadge, Primary } from '../components/ui';
import type { UnitLevel } from '../core/types';

// Flashcard study mode: flip to reveal HE/AR translation + example, then
// self-mark. A first taste of the Vocaband game loop, trimmed to one mode.
