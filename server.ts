    ...
    app.use(helmet({
      contentSecurityPolicy: {
        directives: {
          ...
          scriptSrcElem: ["'self'", "'unsafe-inline'", "https://static.cloudflareinsights.com", "https://ajax.cloudflare.com"],  // Explicit script-src-elem needed for Vite module scripts
